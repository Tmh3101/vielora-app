...
export function MockupAICustomize() {
  const t = useTranslations("features.mockups.customize");
  ...
  const skills = [
    { name: t("salesSkill"), icon: MessageCircle },
    { name: t("supportSkill"), icon: HeadphonesIcon },
    { name: t("contentSkill"), icon: PenLine },
  ];
      ...
      <Mockup3DWrapper overflowVisible>
        <div className="relative">
          ...
          <div style={{ transform: "translateZ(6px)" }}>
            <p className="mb-2 text-[11px] text-muted-foreground">{t("personalityLabel")}</p>
