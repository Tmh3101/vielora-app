              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="bg-gradient-primary/10 group-hover:shadow-glow-sm flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl transition-shadow">
                      {bot.avatar_url ? (
                        <Image
                          src={bot.avatar_url}
                          alt={bot.name}
