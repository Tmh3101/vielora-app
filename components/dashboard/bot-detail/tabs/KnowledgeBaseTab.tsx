                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-lg font-bold text-foreground">
                        {pages.filter((p) => p.source_type === EPageSourceType.ManualText).length}
                      </p>
                      <p className="-mt-1 text-xs text-muted-foreground">Văn bản</p>
                    </div>
                  </div>
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <h4 className="truncate font-semibold text-foreground">
                              {isManual ? page.title : page.title || page.url}
                            </h4>
                            <Badge
                              variant="outline"
                            ...
                            >
                              {isManual ? "Văn bản" : "Website"}
                            </Badge>
                          </div>
                          <p className="mt-0.5 truncate text-xs text-muted-foreground">
                            {isManual ? "Đã thêm thủ công" : page.url}
                          </p>
                        </div>
